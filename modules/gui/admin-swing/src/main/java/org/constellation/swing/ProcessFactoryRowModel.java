 ...
 */
public class ProcessFactoryRowModel implements RowModel {

    public static final ResourceBundle BUNDLE = ResourceBundle.getBundle("org/constellation/swing/Bundle");

    public static class EditProcessFactory{}
    public static class DeleteProcessFactory{}
    ...
    public Class getColumnClass(int i) {
        switch(i){
            case 0 : return EditProcessFactory.class;
            case 1 : return DeleteProcessFactory.class;
