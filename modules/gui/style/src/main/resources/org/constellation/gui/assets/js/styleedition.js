...
/**
 * JavaScript controller for "style_edition.gtmpl" page.
 *
 * @type {Object}
 */
CSTL.StyleEdition = {
    ...
    newSymbol: function(type) {
        ...
        switch(type) {
            ...
            case "text":
                ...
                break;
            case "raster":
                symbolizer = CSTL.SldWorkflow.DEFAULT_RASTER_SYMBOL;
                break;
        }
...
CSTL.RasterSymbol = {
    ...
    init: function(symbolIndex) {
        ...
        // Set form values.
        if (this._symbol.channelSelection && this._symbol.channelSelection.rgbChannels) {
            this.showRGBSelection();
            $("[name='select.channel']").val("rgb");
            $("[name='channel.red.name']").val(this._symbol.channelSelection.rgbChannels[0].name);
            $("[name='channel.green.name']").val(this._symbol.channelSelection.rgbChannels[1].name);
            $("[name='channel.blue.name']").val(this._symbol.channelSelection.rgbChannels[2].name);
        } else if(this._symbol.channelSelection.greyChannel) {
            this.showGreySelection();
            $("[name='select.channel']").val("grey");
            $("[name='channel.grey.name']").val(this._symbol.channelSelection.greyChannel.name);
        } else {
            this.showGreySelection();
        }
    },
    ...
    showGreySelection: function() {
        $(".panel-grey").removeClass("hide");
        $(".panel-rgb").addClass("hide");
    },

    showRGBSelection: function() {
        $(".panel-rgb").removeClass("hide");
        $(".panel-grey").addClass("hide");
    },
    ...
    validate: function() {
        // Apply form values.
        this._symbol.channelSelection = {};
        if ($("[name='select.channel']").val() === "rgb") {
            this._symbol.channelSelection.rgbChannels = [];
            this._symbol.channelSelection.rgbChannels[0] = {};
            this._symbol.channelSelection.rgbChannels[0].name = $("[name='channel.red.name']").val();
            this._symbol.channelSelection.rgbChannels[1] = {};
            this._symbol.channelSelection.rgbChannels[1].name = $("[name='channel.green.name']").val();
            this._symbol.channelSelection.rgbChannels[2] = {};
            this._symbol.channelSelection.rgbChannels[2].name = $("[name='channel.blue.name']").val();
        } else {
            this._symbol.channelSelection.greyChannel = {};
            this._symbol.channelSelection.greyChannel.name = $("[name='channel.grey.name']").val();
        }
