 ...
 *
 * @todo Replace by the Apache SIS classes after we migrated it to an internal package with "public" access.
 */
final class LegacyCodes {
    ...
    static {
        ...
        try (InputStream in = Metadata.class.getResourceAsStream("2003/charset-codes.properties")) {
            ...
            Logging.unexpectedException(LegacyCodes.class, "<clinit>", e);
        }
