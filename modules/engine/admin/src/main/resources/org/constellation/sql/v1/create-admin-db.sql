...
ALTER TABLE "admin"."user_x_domain_x_domainrole" ADD CONSTRAINT user_x_domain_x_role_pk PRIMARY KEY ("user_id", "domain_id", "domainrole");
...
insert into "admin"."user_x_domain_x_domainrole" ("user_id", "domainrole", "domain_id") values(1, 'manager', 1);
