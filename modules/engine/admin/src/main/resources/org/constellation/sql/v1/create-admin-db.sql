...
ALTER TABLE "admin"."user_x_role" ADD CONSTRAINT user_x_role_login_fk FOREIGN KEY ("login") REFERENCES "admin"."user"("login") ON DELETE CASCADE;
...
ALTER TABLE "admin"."permission" ADD CONSTRAINT permission_pk PRIMARY KEY ("name");

CREATE TABLE "admin"."domainrole_x_permission" (
    "domainrole_id" VARCHAR(32) NOT NULL,
...
ALTER TABLE "admin"."domainrole_x_permission" ADD CONSTRAINT domainrole_x_permission_domainrole_id_fk FOREIGN KEY ("domainrole_id") REFERENCES "admin"."domainrole"("name") ON DELETE CASCADE;
ALTER TABLE "admin"."domainrole_x_permission" ADD CONSTRAINT domainrole_x_permission_permission_id_fk FOREIGN KEY ("permission_id") REFERENCES "admin"."permission"("name") ON DELETE CASCADE;
...
ALTER TABLE "admin"."user_x_domain_x_domainrole" ADD CONSTRAINT user_x_domain_x_role_login_fk FOREIGN KEY ("login") REFERENCES "admin"."user"("login")  ON DELETE CASCADE;
...
ALTER TABLE "admin"."user_x_domain_x_domainrole" ADD CONSTRAINT user_x_domain_x_role_role_fk FOREIGN KEY ("domainrole") REFERENCES "admin"."domainrole"("name")  ON DELETE CASCADE;
...
insert into "admin"."permission" ("name", "description") values ('CREATE_SERVICE', 'Création de service');
insert into "admin"."permission" ("name", "description") values ('CREATE_DATA', 'Création de data');
...
insert into "admin"."domainrole_x_permission" ("domainrole_id", "permission_id") values('manager', 'CREATE_SERVICE');
insert into "admin"."domainrole_x_permission" ("domainrole_id", "permission_id") values('manager', 'CREATE_DATA');
