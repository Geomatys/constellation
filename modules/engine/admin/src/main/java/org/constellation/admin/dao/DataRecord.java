...
public final class DataRecord implements Record {
    ...
    DataRecord(final Session session, final int id, final String name, final int provider, final DataType type,
    ...
    public DataRecord(final Session s, final ResultSet rs) throws SQLException {
        this(s, rs.getInt(1),
                rs.getString(2),
                rs.getInt(3),
                DataType.valueOf(rs.getString(4)),
    ...
    public void setName(final String name) throws SQLException {
        this.name = name;
        session.updateData(id, name, provider, type, owner);
    }
    ...
    public void setProvider(final ProviderRecord provider) throws SQLException {
        ...
        session.updateData(id, name, provider.id, type, owner);
    }
    ...
    public void setOwner(final UserRecord owner) throws SQLException {
        ...
        session.updateData(id, name, provider, type, owner.getLogin());
    }
