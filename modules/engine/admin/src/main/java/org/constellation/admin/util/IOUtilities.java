...
public final class IOUtilities extends Static {
     ...
     * @throws IOException on error while writing {@link MutableStyle} XML
     */
    ...
    /**
     * Transform a {@link GeneralParameterValue} instance into a {@link String} instance.
     *
     * @param parameter the parameter to be written
     * @return a {@link String} instance
     * @throws IOException on error while writing {@link GeneralParameterValue} XML
     */
    ...
    /**
     * Reads an {@link InputStream} to build a {@link GeneralParameterValue} instance
     * according the specified {@link ParameterDescriptorGroup}.
     *
