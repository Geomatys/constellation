...
--
-- Spring security views 
-- 
CREATE VIEW users AS
  SELECT "login" AS username, "password" AS password, "active" AS enabled
  FROM "admin"."user";
  
CREATE VIEW authorities AS
  SELECT "u"."login" AS username, "uXr"."role" AS authority
  FROM "admin"."user" "u" LEFT JOIN "admin"."user_x_role" "uXr" ON "u"."id" = "uXr"."user_id";
