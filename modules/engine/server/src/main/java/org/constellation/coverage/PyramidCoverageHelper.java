...
public class PyramidCoverageHelper {
	...
	private static abstract class WithOutputImpl implements WithOutput {
		...
		public PyramidCoverageHelper build() throws DataStoreException {
			PyramidCoverageHelper helper = new PyramidCoverageHelper(
					builder);
	 ...
	 * 
	 */
	public static abstract class WithInput {

		Builder builder;

		public WithInput(Builder builder) {
			this.builder = builder;
		}
	 ...
	 * 
	 */
	private static abstract class WithInputImpl extends WithInput {
		public WithInputImpl(Builder builder) {
			super(builder);
		}

		abstract CoverageStore buildInputStore(String inputFormat)
				throws DataStoreException;
