 ...
 */
public class OldCSTLPortrayalService extends DefaultPortrayalService {
     ...
     */
    private static final ThreadLocal<OldCSTLPortrayalService> instances = new ThreadLocal<OldCSTLPortrayalService>() {
        @Override
        protected OldCSTLPortrayalService initialValue() {
            return new OldCSTLPortrayalService();
        }
    };
    ...
    public static OldCSTLPortrayalService getInstance(){
