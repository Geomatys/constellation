...
public class CstlPortrayalService extends DefaultPortrayalService implements PortrayalServiceIF {
     ...
     */
    @Override
    public File writeInImage(Exception e, Dimension dim, File output, String mime) 
    		throws IOException {
    	
    	//TODO: should this not be in the next method
        LOGGER.log(Level.WARNING, "Error image created : " + output,e);
        final BufferedImage img = writeInImage(e, dim);
