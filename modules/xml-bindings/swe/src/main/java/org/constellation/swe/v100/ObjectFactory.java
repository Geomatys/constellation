...
public class ObjectFactory {
    ...
    private final static QName _TimeInstantGrid_QNAME = new QName("http://www.opengis.net/swe/1.0", "TimeInstantGrid");
    private final static QName _NormalizedCurve_QNAME = new QName("http://www.opengis.net/swe/1.0", "NormalizedCurve");
    private final static QName _ConditionalValue_QNAME = new QName("http://www.opengis.net/swe/1.0", "ConditionalValue");
    private final static QName _TimeAggregate_QNAME = new QName("http://www.opengis.net/swe/1.0", "TimeAggregate");
    private final static QName _TimeGeometricComplex_QNAME = new QName("http://www.opengis.net/swe/1.0", "TimeGeometricComplex");
    private final static QName _XMLBlock_QNAME = new QName("http://www.opengis.net/swe/1.0", "XMLBlock");
    private final static QName _Position_QNAME = new QName("http://www.opengis.net/swe/1.0", "Position");
    private final static QName _ConditionalData_QNAME = new QName("http://www.opengis.net/swe/1.0", "ConditionalData");
    private final static QName _SquareMatrix_QNAME = new QName("http://www.opengis.net/swe/1.0", "SquareMatrix");
    private final static QName _MultiplexedStreamFormat_QNAME = new QName("http://www.opengis.net/swe/1.0", "MultiplexedStreamFormat");
    private final static QName _DataStreamDefinition_QNAME = new QName("http://www.opengis.net/swe/1.0", "DataStreamDefinition");
    private final static QName _AbstractDataRecord_QNAME = new QName("http://www.opengis.net/swe/1.0", "AbstractDataRecord");
    private final static QName _DataArray_QNAME = new QName("http://www.opengis.net/swe/1.0", "DataArray");
    private final static QName _DataRecord_QNAME = new QName("http://www.opengis.net/swe/1.0", "DataRecord");
    private final static QName _Vector_QNAME = new QName("http://www.opengis.net/swe/1.0", "Vector");
    private final static QName _Interval_QNAME = new QName("http://www.opengis.net/swe/1.0", "Interval");
    private final static QName _AbstractDataArray_QNAME = new QName("http://www.opengis.net/swe/1.0", "AbstractDataArray");
    private final static QName _PhenomenonSeries_QNAME = new QName("http://www.opengis.net/swe/1.0", "PhenomenonSeries");
    private final static QName _SimpleDataRecord_QNAME = new QName("http://www.opengis.net/swe/1.0", "SimpleDataRecord");
    private final static QName _Array_QNAME = new QName("http://www.opengis.net/swe/1.0", "Array");
    private final static QName _Item_QNAME = new QName("http://www.opengis.net/swe/1.0", "Item");
    private final static QName _Curve_QNAME = new QName("http://www.opengis.net/swe/1.0", "Curve");
    private final static QName _TypedValueList_QNAME = new QName("http://www.opengis.net/swe/1.0", "TypedValueList");
    private final static QName _CompoundPhenomenon_QNAME = new QName("http://www.opengis.net/swe/1.0", "CompoundPhenomenon");
    private final static QName _ConstrainedPhenomenon_QNAME = new QName("http://www.opengis.net/swe/1.0", "ConstrainedPhenomenon");
    private final static QName _Envelope_QNAME = new QName("http://www.opengis.net/swe/1.0", "Envelope");
    private final static QName _Phenomenon_QNAME = new QName("http://www.opengis.net/swe/1.0", "Phenomenon");
    private final static QName _TypedValue_QNAME = new QName("http://www.opengis.net/swe/1.0", "TypedValue");
    private final static QName _DataBlockDefinition_QNAME = new QName("http://www.opengis.net/swe/1.0", "DataBlockDefinition");
    private final static QName _Record_QNAME = new QName("http://www.opengis.net/swe/1.0", "Record");
    private final static QName _TimeIntervalGrid_QNAME = new QName("http://www.opengis.net/swe/1.0", "TimeIntervalGrid");
    private final static QName _CompositePhenomenon_QNAME = new QName("http://www.opengis.net/swe/1.0", "CompositePhenomenon");
    private final static QName _TimeGrid_QNAME = new QName("http://www.opengis.net/swe/1.0", "TimeGrid");
    private final static QName _GeoLocationArea_QNAME = new QName("http://www.opengis.net/swe/1.0", "GeoLocationArea");
    private final static QName _AllowedTokensValueList_QNAME = new QName("http://www.opengis.net/swe/1.0", "valueList");
    private final static QName _AllowedTimesInterval_QNAME = new QName("http://www.opengis.net/swe/1.0", "interval");
