...
cstlAdminApp.factory('webService', ['$resource',
                                     function ($resource) {
                                         return $resource(cstlContext+'api/1/admin/instances', {}, {
                                             ...
                                             'restart': {method: 'POST', url: cstlContext+'1/OGC/:type/:id/restart'},
                                             'start': {method: 'POST', url: cstlContext+'1/OGC/:type/:id/start'},
                                             'stop': {method: 'POST', url: cstlContext+'1/OGC/:type/:id/stop'},
