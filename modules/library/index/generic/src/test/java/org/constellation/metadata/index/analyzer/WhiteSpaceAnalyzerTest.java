...
public class WhiteSpaceAnalyzerTest extends AbstractAnalyzerTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        GenericIndexer indexer = new GenericIndexer(object, null, configDirectory, "", new WhitespaceAnalyzer(Version.LATEST), Level.FINER, true);
        indexer.destroy();

        indexSearcher          = new LuceneIndexSearcher(configDirectory, "", new WhitespaceAnalyzer(Version.LATEST), true);
