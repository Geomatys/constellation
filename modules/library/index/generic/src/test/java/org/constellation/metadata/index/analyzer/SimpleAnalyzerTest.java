...
public class SimpleAnalyzerTest extends AbstractAnalyzerTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        GenericIndexer indexer = new GenericIndexer(object, null, configDirectory, "", new SimpleAnalyzer(Version.LUCENE_45), Level.FINER, true);
        indexer.destroy();
        indexSearcher          = new LuceneIndexSearcher(configDirectory, "", new SimpleAnalyzer(Version.LUCENE_45), true);
