...
public class WhiteSpaceAnalyzerTest extends AbstractAnalyzerTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        GenericIndexer indexer = new GenericIndexer(object, null, configDirectory, "", new WhitespaceAnalyzer(Version.LUCENE_33), Level.FINER);
        indexer.destroy();
        
        indexSearcher          = new AbstractIndexSearcher(configDirectory, "", new WhitespaceAnalyzer(Version.LUCENE_33));
