...
public class WithinFilter extends SpatialFilter {
    ...
    public BitSet bits(IndexReader reader) throws IOException {
        ...
        while (termDocs.next()) {
            ...
            final GeneralDirectPosition tempPoint1 = new GeneralDirectPosition(tempLine.getX1(), tempLine.getY1());
            tempPoint1.setCoordinateReferenceSystem(geometryCRS);
            final GeneralDirectPosition tempPoint2 = new GeneralDirectPosition(tempLine.getX2(), tempLine.getY2());
