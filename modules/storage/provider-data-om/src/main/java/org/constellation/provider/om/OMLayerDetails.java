 ...
 */
class OMLayerDetails extends AbstractFeatureLayerDetails {

    OMLayerDetails(String name, FeatureSource<SimpleFeatureType,SimpleFeature> fs, List<String> favorites){
