...
public class CSWRequestTest extends AbstractTestRequest {
    ...
    private static final String CSW_POST_URL = "http://localhost:9090/default/csw?";

    private static final String CSW_GETCAPABILITIES_URL = "http://localhost:9090/default/csw?request=GetCapabilities&service=CSW&version=2.0.2";
