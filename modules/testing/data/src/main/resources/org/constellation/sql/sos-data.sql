...
INSERT INTO "observation"."any_scalars" ("id_datablock", "id_datarecord", "name", "definition", "type", "uom_code", "uom_href", "value") VALUES ('dataArray-0', 'datarecord-0', 'depth', 'urn:ogc:def:phenomenon:GEOM:depth', 'Quantity', 'm', NULL, NULL);
...
INSERT INTO "observation"."any_scalars" ("id_datablock", "id_datarecord", "name", "definition", "type", "uom_code", "uom_href", "value") VALUES ('dataArray-1', 'datarecord-0', 'depth', 'urn:ogc:def:phenomenon:GEOM:depth', 'Quantity', 'm', NULL, NULL);
...
INSERT INTO "observation"."any_scalars" ("id_datablock", "id_datarecord", "name", "definition", "type", "uom_code", "uom_href", "value") VALUES ('dataArray-2', 'datarecord-0', 'depth', 'urn:ogc:def:phenomenon:GEOM:depth', 'Quantity', 'm', NULL, NULL);
...
INSERT INTO "observation"."any_scalars" ("id_datablock", "id_datarecord", "name", "definition", "type", "uom_code", "uom_href", "value") VALUES ('dataArray-3', 'datarecord-1', 'depth', 'urn:ogc:def:phenomenon:GEOM:depth', 'Quantity', 'm', NULL, NULL);
INSERT INTO "observation"."any_scalars" ("id_datablock", "id_datarecord", "name", "definition", "type", "uom_code", "uom_href", "value") VALUES ('dataArray-3', 'datarecord-1', 'temperature', 'urn:ogc:def:phenomenon:GEOM:temperature', 'Quantity', '°C', NULL, NULL);
...
INSERT INTO "observation"."any_scalars" ("id_datablock", "id_datarecord", "name", "definition", "type", "uom_code", "uom_href", "value") VALUES ('dataArray-4', 'datarecord-1', 'depth', 'urn:ogc:def:phenomenon:GEOM:depth', 'Quantity', 'm', NULL, NULL);
INSERT INTO "observation"."any_scalars" ("id_datablock", "id_datarecord", "name", "definition", "type", "uom_code", "uom_href", "value") VALUES ('dataArray-4', 'datarecord-1', 'temperature', 'urn:ogc:def:phenomenon:GEOM:temperature', 'Quantity', '°C', NULL, NULL);
...
INSERT INTO "observation"."observations" ("name", "description", "feature_of_interest", "procedure", "sampling_time_begin", "sampling_time_end", "result_definition", "observed_property", "result", "distribution", "feature_of_interest_point", "observed_property_composite", "feature_of_interest_curve") VALUES ('urn:ogc:object:observation:template:GEOM:8', NULL, NULL, 'urn:ogc:object:sensor:GEOM:8', NULL, NULL, NULL, NULL, 9, 'normale', NULL, 'aggregatePhenomenon', 'station-006');
...
INSERT INTO "observation"."observations" ("name", "description", "feature_of_interest", "procedure", "sampling_time_begin", "sampling_time_end", "result_definition", "observed_property", "result", "distribution", "feature_of_interest_point", "observed_property_composite", "feature_of_interest_curve") VALUES ('urn:ogc:object:observation:GEOM:801', NULL, NULL, 'urn:ogc:object:sensor:GEOM:8', '2007-05-01 12:59:00.0', '2007-05-01 16:59:00.0', NULL, NULL, 10, 'normale', NULL, 'aggregatePhenomenon', 'station-006');
