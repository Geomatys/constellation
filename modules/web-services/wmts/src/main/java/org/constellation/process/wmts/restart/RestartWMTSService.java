...
import static org.constellation.process.wmts.restart.RestartWMTSServiceDescriptor.*;
 ...
 */
public final class RestartWMTSService extends AbstractCstlProcess {

    public RestartWMTSService(final ProcessDescriptor desc, final ParameterValueGroup parameter) {
    ...
    protected void execute() throws ProcessException {
        ...
        if (configDirectory != null && configDirectory.isDirectory()) {
            ...
            final String serviceName = ServiceDef.WMTS_1_0_0.specification.name();
    ...
    private void buildWorkers(final File serviceDir, final String identifier, final boolean closeInstance) throws ProcessException {
        ...
        if (identifier != null) {
            ...
            if (instanceDirectory.exists() && serviceDir.isDirectory()) {
                final DefaultWMTSWorker worker = new DefaultWMTSWorker(identifier, instanceDirectory);
                if (worker != null) {
                    ...
                    */
                    if (instanceDir.isDirectory()) {
                        ...
                        if (oldWorkersMap.containsKey(instanceDir.getName())) {
                            final DefaultWMTSWorker worker = new DefaultWMTSWorker(identifier, instanceDir);
                            if (worker != null) {
