...
import static org.constellation.process.wmts.start.StartWMTSServiceDescriptor.*;
/**
 *
 * @author Quentin Boileau (Geomatys).
 */
public final class StartWMTSService extends AbstractCstlProcess {

    public StartWMTSService(final ProcessDescriptor desc, final ParameterValueGroup parameter) {
