...
import static org.constellation.process.wmts.stop.StopWMTSServiceDescriptor.*;
 ...
 */
public class StopWMTSService extends AbstractCstlProcess {

    public StopWMTSService(final ProcessDescriptor desc, final ParameterValueGroup parameter) {
