...
public class UpdateMapStyleTest extends AbstractMapStyleTest {
    ...
    public UpdateMapStyleTest() {
        super(UpdateStyleToStyleProviderDescriptor.NAME);
    }
    ...
    public void testCreateStyle() throws ProcessException, NoSuchIdentifierException, MalformedURLException {
        ...
        final ProcessDescriptor desc = ProcessFinder.getProcessDescriptor(ConstellationProcessFactory.NAME, UpdateStyleToStyleProviderDescriptor.NAME);
        ...
        in.parameter(UpdateStyleToStyleProviderDescriptor.PROVIDER_ID_NAME).setValue("updateStyleProvider1");
        in.parameter(UpdateStyleToStyleProviderDescriptor.STYLE_ID_NAME).setValue("styleToUpdate");
        in.parameter(UpdateStyleToStyleProviderDescriptor.STYLE_NAME).setValue(newStyle);
    ...
    public void testFailCreateStyle1() throws ProcessException, NoSuchIdentifierException, MalformedURLException {
        ...
        final ParameterValueGroup in = desc.getInputDescriptor().createValue();
        in.parameter(UpdateStyleToStyleProviderDescriptor.PROVIDER_ID_NAME).setValue("updateStyleProvider2");
        in.parameter(UpdateStyleToStyleProviderDescriptor.STYLE_ID_NAME).setValue("myStyle");
        in.parameter(UpdateStyleToStyleProviderDescriptor.STYLE_NAME).setValue(style);
    ...
    public void testFailCreateStyle2() throws ProcessException, NoSuchIdentifierException, MalformedURLException {
        ...
        final ParameterValueGroup in = desc.getInputDescriptor().createValue();
        in.parameter(UpdateStyleToStyleProviderDescriptor.PROVIDER_ID_NAME).setValue("");
        in.parameter(UpdateStyleToStyleProviderDescriptor.STYLE_ID_NAME).setValue("myStyle");
        in.parameter(UpdateStyleToStyleProviderDescriptor.STYLE_NAME).setValue(style);
    ...
    public void testFailCreateStyle3() throws ProcessException, NoSuchIdentifierException, MalformedURLException {
        ...
        final ParameterValueGroup in = desc.getInputDescriptor().createValue();
        in.parameter(UpdateStyleToStyleProviderDescriptor.PROVIDER_ID_NAME).setValue("updateStyleProvider3");
        in.parameter(UpdateStyleToStyleProviderDescriptor.STYLE_ID_NAME).setValue("");
        in.parameter(UpdateStyleToStyleProviderDescriptor.STYLE_NAME).setValue(style);
