 ...
 */
public class CreateMapStyleDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "createMapStyle";
     ...
     */
    public CreateMapStyleDescriptor() {
        super(NAME, ConstellationProcessFactory.IDENTIFICATION, ABSTRACT, INPUT_DESC, OUTPUT_DESC);
    }

    @Override
    public org.geotoolkit.process.Process createProcess(ParameterValueGroup input) {
        return new CreateMapStyle(this, input);
    }
}
