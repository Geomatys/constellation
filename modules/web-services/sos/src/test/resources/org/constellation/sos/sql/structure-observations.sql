...
ALTER TABLE "sos"."observation_offerings"
    ADD CONSTRAINT observation_offerings_pkey PRIMARY KEY ("id");



ALTER TABLE "sos"."offering_procedures"
    ADD CONSTRAINT offering_procedures_pkey PRIMARY KEY ("id_offering", "procedure");


ALTER TABLE "sos"."offering_phenomenons"
  ADD CONSTRAINT offering_phenomenons_pk PRIMARY KEY("id_offering", "phenomenon", "composite_phenomenon");



ALTER TABLE "sos"."offering_response_modes"
    ADD CONSTRAINT offering_response_modes_pkey PRIMARY KEY ("id_offering", "mode");




ALTER TABLE "sos"."offering_sampling_features"
    ADD CONSTRAINT offering_sampling_feature PRIMARY KEY ("id_offering", "sampling_feature");



ALTER TABLE "sos"."projected_localisations"
    ADD CONSTRAINT projected_pk PRIMARY KEY ("id");



ALTER TABLE "observation"."components"
    ADD CONSTRAINT components_component_fkey FOREIGN KEY ("component") REFERENCES "observation"."phenomenons"("id");




ALTER TABLE "observation"."components"
    ADD CONSTRAINT components_composite_phenomenon_fkey FOREIGN KEY ("composite_phenomenon") REFERENCES "observation"."composite_phenomenons"("id");



ALTER TABLE "observation"."data_array_definition"
    ADD CONSTRAINT data_array_encoding_fk FOREIGN KEY ("encoding") REFERENCES "observation"."text_block_encodings"("id_encoding");




ALTER TABLE "observation"."data_block_definitions"
    ADD CONSTRAINT data_block_definitions_encoding_fkey FOREIGN KEY ("encoding") REFERENCES "observation"."text_block_encodings"("id_encoding");




ALTER TABLE "observation"."any_scalars"
    ADD CONSTRAINT data_record_fields_id_datablock_fkey FOREIGN KEY ("id_datablock", "id_datarecord") REFERENCES "observation"."simple_data_records"("id_datablock", "id_datarecord");



ALTER TABLE "observation"."measurements"
    ADD CONSTRAINT measurements_feature_of_interest_fkey FOREIGN KEY ("feature_of_interest") REFERENCES "observation"."sampling_features"("id");




ALTER TABLE "observation"."measurements"
    ADD CONSTRAINT measurements_observed_property_fkey FOREIGN KEY ("observed_property") REFERENCES "observation"."phenomenons"("id");



ALTER TABLE "observation"."measurements"
    ADD CONSTRAINT measurements_procedure_fkey FOREIGN KEY ("procedure") REFERENCES "observation"."process"("name");




ALTER TABLE "observation"."measurements"
    ADD CONSTRAINT measurements_result_fkey FOREIGN KEY ("result") REFERENCES "observation"."measures"("name");




ALTER TABLE "observation"."measures"
    ADD CONSTRAINT measures_uom_fkey FOREIGN KEY ("uom") REFERENCES "observation"."unit_of_measures"("id");



ALTER TABLE "observation"."observations"
    ADD CONSTRAINT observations_distribution_fkey FOREIGN KEY ("distribution") REFERENCES "observation"."Distributions"("name");



ALTER TABLE "observation"."observations"
    ADD CONSTRAINT observations_feature_of_interest_fkey FOREIGN KEY ("feature_of_interest") REFERENCES "observation"."sampling_features"("id");



ALTER TABLE "observation"."observations"
    ADD CONSTRAINT observations_feature_of_interest_point_fkey FOREIGN KEY ("feature_of_interest_point") REFERENCES "observation"."sampling_points"("id");



ALTER TABLE "observation"."observations"
    ADD CONSTRAINT observations_observed_property_composite_fkey FOREIGN KEY ("observed_property_composite") REFERENCES "observation"."composite_phenomenons"("id");



ALTER TABLE "observation"."observations"
    ADD CONSTRAINT observations_observed_property_fkey FOREIGN KEY ("observed_property") REFERENCES "observation"."phenomenons"("id");



ALTER TABLE "observation"."observations"
    ADD CONSTRAINT observations_procedure_fkey FOREIGN KEY ("procedure") REFERENCES "observation"."process"("name");


ALTER TABLE "observation"."observations"
    ADD CONSTRAINT observations_result_definition_fkey FOREIGN KEY ("result_definition") REFERENCES "observation"."data_block_definitions"("id");



ALTER TABLE "observation"."observations"
    ADD CONSTRAINT observations_result_fkey FOREIGN KEY ("result") REFERENCES "observation"."any_results"("id_result");



ALTER TABLE "observation"."any_results"
    ADD CONSTRAINT reference_pk FOREIGN KEY ("reference") REFERENCES "observation"."references"("id_reference");




ALTER TABLE "sos"."observation_offerings"
    ADD CONSTRAINT observation_offerings_bounded_by_fkey FOREIGN KEY ("bounded_by") REFERENCES "sos"."envelopes"("id");
...
ALTER TABLE "sos"."offering_phenomenons"
    ADD CONSTRAINT offering_phenomenons_id_offering_fkey FOREIGN KEY ("id_offering") REFERENCES "sos"."observation_offerings"("id");
...
ALTER TABLE "sos"."offering_procedures"
    ADD CONSTRAINT offering_procedures_id_offering_fkey FOREIGN KEY ("id_offering") REFERENCES "sos"."observation_offerings"("id");



ALTER TABLE "sos"."offering_sampling_features"
    ADD CONSTRAINT offering_sampling_features_id_offering_fkey FOREIGN KEY ("id_offering") REFERENCES "sos"."observation_offerings"("id");
