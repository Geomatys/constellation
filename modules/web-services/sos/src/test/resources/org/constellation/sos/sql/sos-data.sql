...
--INSERT INTO "observation"."any_scalars" ("id_datablock", "id_datarecord", "name", "definition", "type", "uom_code", "uom_href", "value") VALUES ('dataArray-0', 'datarecord', 'temperature', 'urn:x-ogc:def:phenonmenon:GEOM:temperature', 'Quantity', 'degC', NULL, NULL);
