...
public class SOSFactoryTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        while (ite.hasNext()) {
            ...
            if (currentFactory.factoryMatchType(DataSourceType.OM2)) {
    ...
    public void defaultTypeTest() throws Exception {
        ...
        final Automatic config   = new Automatic("om2", bdd);
        ...
        try  {
            ObservationFilter of = omFactory.getObservationFilter(DataSourceType.OM2, config, parameters);
        ...
        exLaunched = false;
        try  {
            ObservationReader or = omFactory.getObservationReader(DataSourceType.OM2, config, parameters);
