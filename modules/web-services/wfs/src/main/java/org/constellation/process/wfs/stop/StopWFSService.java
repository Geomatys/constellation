...
import static org.constellation.process.wfs.stop.StopWFSServiceDescriptor.*;
 ...
 */
public class StopWFSService extends AbstractCstlProcess {

    public StopWFSService(final ProcessDescriptor desc, final ParameterValueGroup parameter) {
