 ...
 */
public class StopWFSServiceDescriptor extends AbstractProcessDescriptor {

    public static final String NAME = "stopWFSService";
    public static final InternationalString ABSTRACT = new SimpleInternationalString("Stop the instance for the specified WFS identifier.");
     ...
     */
    public StopWFSServiceDescriptor() {
        super(NAME, ConstellationProcessFactory.IDENTIFICATION, ABSTRACT, INPUT_DESC, OUTPUT_DESC);
    }

    @Override
    public org.geotoolkit.process.Process createProcess(ParameterValueGroup input) {
        return new StopWFSService(this, input);
    }
}
