...
import static org.constellation.process.wfs.restart.RestartWFSServiceDescriptor.*;
 ...
 */
public final class RestartWFSService extends AbstractCstlProcess {

    public RestartWFSService(final ProcessDescriptor desc, final ParameterValueGroup parameter) {
                    ...
                    */
                    if (instanceDir.isDirectory()) {
                        ...
                        if (oldWorkersMap.containsKey(instanceDir.getName())) {
                            final DefaultWFSWorker worker = new DefaultWFSWorker(identifier, instanceDir);
                            if (worker != null) {
