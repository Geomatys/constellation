 ...
 */
package org.constellation.process.wfs;
 ...
 */
public abstract class WFSProcessTest extends AbstractProcessTest {

    protected static File configDirectory;

    public WFSProcessTest(final String str) {
        super(str);
    }
    ...
    protected static void createInstance(String identifier) {
        ...
        final File instance = new File(wfs, identifier);
        instance.mkdir();
    ...
    protected static void startInstance(String identifier) {
        final File wfs = new File(configDirectory, "WFS");
        final File instance = new File(wfs, identifier);
        final DefaultWFSWorker worker = new DefaultWFSWorker(identifier, instance);
        if (worker != null) {
            WSEngine.addServiceInstance("WFS", identifier, worker);
        }
    }
}
