...
public class CSWorkerInitialisationTest implements ApplicationContextAware {
	...
	public void initialisationTest() throws Exception {
		...
		/**
		 * Test 7: A configuration file with mdweb database and wrong database
		 * config.
		 */
		sw = new StringWriter();
		s = null;
		...
		/**
		 * Test 8: A configuration file with mdweb mode and wrong database
		 * config.
		 */
		sw = new StringWriter();
		...
		/**
		 * Test 9: A configuration file with mdweb mode and wrong database
		 * config.
		 */
		sw = new StringWriter();
		...
		/**
		 * Test 10: A configuration file with mdweb mode and wrong database
		 * config.
		 */
		sw = new StringWriter();
		configuration = new Automatic("mdweb", new BDD(null, "whatever", null,
				null));
		tempMarshaller.marshal(configuration, sw);
		...
		/**
		 * Test 11: A configuration file with mdweb mode and wrong database
		 * config.
		 */
		sw = new StringWriter();
		configuration = new Automatic("mdweb", new BDD("org.postgresql.Driver",
				"whatever", null, null));
		tempMarshaller.marshal(configuration, sw);
