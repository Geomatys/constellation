...
public class IndexLuceneTest {
    ...
    public static List<Form> fillTestData(List<Path> paths, List<Classe> classes) {
        ...
        //The forms
        Date d = new Date(120);
        Form f1 = new Form(1, cat, "title1", null, null, null, d, false, false, "normalForm");
        ...
        Form f2 = new Form(2, cat, "title2", null, null, null, d, false, false, "normalForm");
        ...
        Form f3 = new Form(3, cat, "title3", null, null, null, d, false, false, "normalForm");
        ...
        Form f4 = new Form(4, cat, "title4", null, null, null, d, false, false, "normalForm");
