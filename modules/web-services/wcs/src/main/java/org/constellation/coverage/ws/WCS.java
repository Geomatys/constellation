...
/**
 * A WCS instance which can be run with:
 * <pre>
 *     java -jar cstl-web-wcs-0.3-SNAPSHOT.jar -port=9090 -duration=-1
 * </pre>
 * see the help for details.
 * <pre>
 *     java -jar cstl-web-wcs-0.3-SNAPSHOT.jar -help
 * </pre>
 * @author Adrian Custer
 * @since 0.3
 *
 */
public class WCS extends CstlEmbeddedService {
