...
public class SensorReader {
    ...
    public SensorReader(PGSimpleDataSource dataSourceSML, String sensorIdBase, Properties map) throws IOException, NoSuchTableException, SQLException {
    ...
    public String getSensor(String sensorId) throws SQLException, WebServiceException {
    ...
    public String getSRSName(Form form) throws SQLException {
    ...
    public String getSensorCoordinates(Form form) throws SQLException {
    ...
    public List<Integer> getNetworkIndex(Form form) throws SQLException {
        int i = 1;
    ...
    public ResultSet getNetworkName(Form form, String networkName) throws SQLException {
        getValueStmt.setString(1, "SensorML:SensorML.1:member.1:classification.1:classifier." + networkName + ":value.1");
        getValueStmt.setInt(2,    form.getId());
        return getValueStmt.executeQuery();
    }
