...
public class ObservationFilter {
    ...
    private ResponseModeType requestMode;
     ...
     *
     */
    public ObservationFilter(String observationIdBase, String observationTemplateIdBase, Properties map, Connection connection) {
     ...
     */
    public ResponseModeType getRequestMode() {
        return requestMode;
    }
     ...
     */
    public void setRequestMode(ResponseModeType currentMode) {
        this.requestMode = currentMode;
    }

    /**
     * Initialize the query.
     */
    public void initFilterObservation() {
    ...
    public List<ObservationResult> filterResult() throws WebServiceException {
