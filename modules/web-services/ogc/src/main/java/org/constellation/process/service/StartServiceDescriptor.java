...
public final class StartServiceDescriptor extends AbstractProcessDescriptor {
    ...
    private static final String SERVICE_REMARKS = "The name of the service";
    public static final ParameterDescriptor<String> SERVICE =
            new DefaultParameterDescriptor(SERVICE_NAME, SERVICE_REMARKS, String.class, null, true);
    ...
    public static final ParameterDescriptorGroup INPUT_DESC =
            ...
            new GeneralParameterDescriptor[]{SERVICE, IDENTIFIER, SERVICE_DIRECTORY});
