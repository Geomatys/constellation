...
public class LinearModelTable extends Table {
     ...
     */
    public LinearModelTable(final LinearModelTable table) {
        super(table);
    }

    /**
     * Sets the descriptor table to use. This method is invoked by {@link net.sicade.coverage.catalog.LayerTable}
