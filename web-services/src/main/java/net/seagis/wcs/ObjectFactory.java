...
public class ObjectFactory {
   ...
   /**
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opengis.net/wcs", name = "SupportedCRS", scope = CoverageSummaryType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opengis.net/wcs", name = "SupportedFormat", scope = CoverageSummaryType.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opengis.net/wcs", name = "GridCRS")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.opengis.net/wcs", name = "CoverageSummary")
