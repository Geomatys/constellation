...
public class ObjectFactory {
    ...
    private final static QName _SnippetDenominator_QNAME = new QName("http://www.opengis.net/kml/2.2", "snippetDenominator");
    ...
    private final static QName _ScaleDenominator_QNAME = new QName("http://www.opengis.net/kml/2.2", "scaleDenominator");
    ...
    public JAXBElement<String> createSnippetDenominator(String value) {
    ...
    public JAXBElement<Double> createScaleDenominator(Double value) {
