...
public class ObjectFactory {
    ...
    private final static QName _AbstractGeometryCollection_QNAME = new QName("http://www.opengis.net/gml", "AbstractGeometryCollection");
    ...
    private final static QName _AbstractGeometryProperty_QNAME = new QName("http://www.opengis.net/gml", "AbstractGeometryProperty");
    ...
    public JAXBElement<GeometryCollectionType> createAbstractGeometryCollection(GeometryCollectionType value) {
    ...
    public JAXBElement<GeometryAssociationType> createAbstractGeometryProperty(GeometryAssociationType value) {
