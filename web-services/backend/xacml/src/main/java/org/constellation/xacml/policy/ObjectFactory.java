 ...
 */
package org.constellation.xacml.policy;
...
/**
 * This object contains factory methods for each Java content interface and Java element interface generated in the org.constellation.xacml.policy.package. 
...
public class ObjectFactory
{
   ...
   private final static QName _PolicySetCombinerParam_QNAME    = new QName("urn:oasis:names:tc:xacml:2.0:policy:schema:os", "PolicySetCombinerParameters");
   ...
   private final static QName _ActionAttrDesignator_QNAME      = new QName("urn:oasis:names:tc:xacml:2.0:policy:schema:os", "ActionAttributeDesignator");
   private final static QName _PolicyCombinerParam_QNAME       = new QName("urn:oasis:names:tc:xacml:2.0:policy:schema:os", "PolicyCombinerParameters");
   private final static QName _Obligation_QNAME                = new QName("urn:oasis:names:tc:xacml:2.0:policy:schema:os", "Obligation");
   private final static QName _ResourceAttrDesignator_QNAME    = new QName("urn:oasis:names:tc:xacml:2.0:policy:schema:os", "ResourceAttributeDesignator");
   private final static QName _Function_QNAME                  = new QName("urn:oasis:names:tc:xacml:2.0:policy:schema:os", "Function");
   private final static QName _EnvironmentAttrDesignator_QNAME = new QName("urn:oasis:names:tc:xacml:2.0:policy:schema:os", "EnvironmentAttributeDesignator");
   ...
   private final static QName _SubjectAttrDesignator_QNAME     = new QName("urn:oasis:names:tc:xacml:2.0:policy:schema:os", "SubjectAttributeDesignator");
   ...
   /**
    * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.constellation.xacml.policy.
    * 
    */
